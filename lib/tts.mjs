...
// Persona defaults — a bright, friendly companion. `voice` is a Kokoro voice id (v1.0 pack); FR gets a
// native French voice so "quoi de neuf" doesn't come out with an English accent. All easily swappable.
export const PERSONA = Object.freeze({
  ...
  kokoro: { en: 'af_heart', fr: 'ff_siwis' },   // warm EN female · native FR female
